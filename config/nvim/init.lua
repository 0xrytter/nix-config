...
require('lazy').setup({
  ...
  { -- autoclosing tags on autocomplete accept
  ...
  { -- Autocompletion
    ...
    config = function()
      ...
      -- Autocommand to set up nvim-cmp for SQL files
      vim.api.nvim_create_autocmd('FileType', {
        pattern = { 'sql', 'mysql', 'plsql' }, -- Add any other SQL-related filetypes here
        callback = function()
          cmp.setup.buffer {
            sources = {
              { name = 'vim-dadbod-completion' }, -- Add vim-dadbod-completion as a source
              { name = 'buffer' }, -- Include the current buffer as a source
              { name = 'nvim_lsp' }, -- Optionally include other sources
              { name = 'luasnip' },
              { name = 'path' },
            },
          }
